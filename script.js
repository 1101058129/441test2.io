document.addEventListener('DOMContentLoaded', function() {
    const products = [
        { name: 'Business Administration Program', price: 10 },
        { name: 'Information Technology (IT) Courses', price: 15 },
        { name: 'Architecture and Engineering Programs', price: 20 },
        { name: 'Health and Nursing Programs', price: 25 },
        { name: 'Creative Industries Courses', price: 30 }
    ];
